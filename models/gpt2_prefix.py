...
class ClipCaptionModel(nn.Module):
    ...
    def __init__(self, prefix_length: int, clip_length: Optional[int] = None,
        ...
        self.prefix_length = prefix_length
        self.gpt = GPT2LMHeadModel.from_pretrained('/mnt/data/Xiangfei/CG-IAA/gpt2')
...
def load_aesmodel(path_weights_mode):
    prefix_length = 40
    model_path = path_weights_mode
    mapping_type_name = 'transformer_encoder'
    mapping_type = {'mlp': MappingType.MLP, 'transformer_encoder': MappingType.TransformerEncoder,
                    'transformer_decoder': MappingType.TransformerDecoder}[mapping_type_name]
    model = ClipCaptionModel(40, prefix_dim=512, clip_length=40,
